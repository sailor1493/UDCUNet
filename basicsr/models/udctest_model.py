...
class UDCTestModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(UDCTestModel, self).__init__(opt)
            ...
            if save_img:
                if self.opt["is_train"]:
                    ...
                    if self.opt["val"]["suffix"]:
                        ...
                        sr_npy = sr_npy[0]
                        sr_npy = np.transpose(sr_npy, (1, 2, 0))
                        save_npy_path = osp.join(
                            save_img_path.split("visualization")[0]
                            + "npy/"
                            + dataset_name
                            + "/"
                            + f"{img_name}.npy"
                ...
                if os.path.exists(
                    save_npy_path.split(dataset_name)[0] + dataset_name + "/"
                ):
                    pass
                else:
                    os.makedirs(
